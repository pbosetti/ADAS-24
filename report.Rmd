...
Questo report è basato sulla libreria `memor`. Al momento (Novembre 2024), la versione online del pacchetto è difettosa, ed è quindi necessario installare la versione di sviluppo, più aggiornata. Eseguire i seguenti due comandi nella console di R:
