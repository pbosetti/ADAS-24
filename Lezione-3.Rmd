...
* ho creato una funzione per definire la tabella di verità (o matrice di confusione) per i possibili risultati del test, assumendo che **un positivo sia una bottiglia rotta** (dato che il negativo è sempre la condizione normale, attesa), e quindi un **falso positivo** sia una bottglia intera che secondo il modello dovrebbe rompersi
...
```{r}
mc_t <- table(
  Actual = filter(data, training) %>% pull(OK),
